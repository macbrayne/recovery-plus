...
public record CompassTrigger(ResourceLocation location, Trigger trigger, LocationPredicate predicate, Action action) {
	...
	public static CompassTrigger fromJson(ResourceLocation location, JsonElement json) {
		if (json != null && !json.isJsonNull()) {
			...
			return new CompassTrigger(location, trigger, predicate, action);
		} else {
			return null;
		}
	}
